...
import grammaCyContent from "./content/grammaCyContent.mdx";

const rawReadMeContentModule = require("!!raw-loader!./content/readMeContent.mdx");
const rawReadMeContent = rawReadMeContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawAboutContentModule = require("!!raw-loader!./content/aboutContent.mdx");
const rawAboutContent = rawAboutContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawResumeContentModule = require("!!raw-loader!./content/resumeContent.mdx");
const rawResumeContent = rawResumeContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawLinearRegressionContentModule = require("!!raw-loader!./content/linearRegressionContent.mdx");
const rawLinearRegressionContent =
  rawLinearRegressionContentModule.default.replace(/import .*;\s*/g, "");

const rawMYnotemdContentModule = require("!!raw-loader!./content/MYnotemdContent.mdx");
const rawMYnotemdContent = rawMYnotemdContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawReftypeContentModule = require("!!raw-loader!./content/reftypeContent.mdx");
const rawReftypeContent = rawReftypeContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawPycaptchaContentModule = require("!!raw-loader!./content/pycaptchaContent.mdx");
const rawPycaptchaContent = rawPycaptchaContentModule.default.replace(
  /import .*;\s*/g,
  "",
);

const rawGrammaCyContentModule = require("!!raw-loader!./content/grammaCyContent.mdx");
const rawGrammaCyContent = rawGrammaCyContentModule.default.replace(
  /import .*;\s*/g,
  "",
);
...
const contentMap = {
  ...
  "#projects/grammaCy.md": {
    content: grammaCyContent,
    rawContent: rawGrammaCyContent,
